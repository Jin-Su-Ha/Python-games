...
btn_left_parentheses.grid(row = 0, column = 0, sticky = N+E+W+S, padx = 2, pady = 2)
btn_right_parentheses.grid(row = 0, column = 1, sticky = N+E+W+S, padx = 2, pady = 2)
btn_percent.grid(row = 0, column = 2, sticky = N+E+W+S, padx = 2, pady = 2)
btn_AC.grid(row = 0, column = 3, sticky = N+E+W+S, padx = 2, pady = 2)
...
btn_division.grid(row = 1, column = 3, sticky = N+E+W+S, padx = 2, pady = 2)
...
btn_multiplication.grid(row = 2, column = 3, sticky = N+E+W+S, padx = 2, pady = 2)
...
btn_subtraction.grid(row = 3, column = 3, sticky = N+E+W+S, padx = 2, pady = 2)
...
btn_0.grid(row = 4, column = 0, sticky = N+E+W+S, padx = 2, pady = 2)
btn_dot.grid(row = 4, column = 1, sticky = N+E+W+S, padx = 2, pady = 2)
btn_equal.grid(row = 4, column = 2, sticky = N+E+W+S, padx = 2, pady = 2)
btn_plus.grid(row = 4, column = 3, sticky = N+E+W+S, padx = 2, pady = 2)
